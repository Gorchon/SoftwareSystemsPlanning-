...
const { Builder, By, Key, until } = require('selenium-webdriver'); // ✅ Incluye `until`
...
describe('-1+-1', function () {
    ...
    afterEach(async function () {
        try {
            await driver.wait(until.alertIsPresent(), 500); // ✅ Intenta detectar alertas
            const alert = await driver.switchTo().alert();
            await alert.accept(); // ✅ Las cierra
        } catch (err) {
            // No hay alerta, seguimos
        }
    ...
    it('SubstractingZerov2', async function () {
